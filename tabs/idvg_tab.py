...
def render_idvg_tab():
    ...
    with col_btn1:
        ...
        manual_prefix = col_pfx.number_input("Prefix", value=smart_next_idx, min_value=1, step=1, label_visibility="collapsed", key="idvg_manual_prefix", help="Starting file number")
        custom_name = col_name.text_input("Config Name", value="", placeholder="Name (Opt)", label_visibility="collapsed", key="idvg_custom_name")
