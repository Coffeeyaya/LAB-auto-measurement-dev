...
with tab_time_dep:
    ...
    with col_btn2:
        ...
        script_to_run = st.selectbox("Select Measurement Script", ("time_dep_app.py", "time_dep_servo_app.py", "time_dep_dark_app.py", "time_dep_servo_pulse_app.py"), label_visibility="collapsed")
